...
const HeatmapChart = ({
  ...
  console.log("🌡️ HeatmapChart received aggregationMethod:", aggregationMethod); // ✅ now works
      ...
      tooltip: {
        ...
        formatter: (params) => {
          ...
          return `
            ...
            <div style="color:#374151">${aggregationMethod}: <span style="color:#059669;font-weight:bold;">${c.value.toFixed(2)}</span></div>
