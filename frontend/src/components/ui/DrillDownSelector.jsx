...
const DRILL_TYPES = [
  { 
    ...
    detail: 'Best for hierarchical categorical data like Category > Sub-Category.'
  },
  { 
    key: 'drill-line', 
    label: 'Drill Line', 
    ...
    detail: 'Visualizes Satisfaction or Salary trends over time for current level.'
  },
  { 
    key: 'drill-pie', 
    label: 'Drill Pie', 
  ...
  { 
    ...
    detail: 'Click any arc segment to zoom into that group. Each ring = one hierarchy level.'
  },
  { 
    key: 'drill-heatmap', 
    label: 'Drill Heatmap', 
  ...
  { 
    ...
    detail: 'Heatmap showing correlation coefficients between all numeric metrics.'
  },
  { 
    key: 'drill-histogram', 
    label: 'Histogram', 
...
const DrillDownSelector = ({ activeDrillType, onSelect, isDrillMode, onToggleDrill }) => {
  return (
        ...
        <div className="info-strip">
          ...
          <div className="info-content">
            ...
            <div className="info-footer">
              Hierarchy: <span className="info-footer-val">Automatic categorical discovery</span>
            </div>
          </div>
        </div>
      )}
